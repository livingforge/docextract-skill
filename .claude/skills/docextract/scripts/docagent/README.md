...
```bash
python -m docagent prep .docextract/output/report_docx/result.json --json
...
python -m docagent add .docextract/output/report_docx/result.json  # result.json を登録のみ
  ...
  "documents": [
    {
      ...
      "source": "report.docx",
      "file_type": "docx",
      "result_path": ".docextract/output/report_docx/result.json",  // 抽出結果への参照
