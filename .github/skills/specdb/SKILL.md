...
```bash
cp -r .github/skills/specdb/scaffold specdb-data     # 名前は任意
```
...
```bash
python .github/skills/specdb/scripts/engine.py   --root specdb-data              # 検証レポート + 統計
python .github/skills/specdb/scripts/generate.py --root specdb-data              # 全文書を out/ に生成
python .github/skills/specdb/scripts/generate.py --root specdb-data table-spec   # 指定文書だけ生成
python .github/skills/specdb/scripts/diff.py     --root specdb-data baseline/R1.0  # ベースライン差分
python .github/skills/specdb/scripts/diff.py     --root specdb-data --baselines    # ベースライン一覧
```
